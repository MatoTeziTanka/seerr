...
const messages = defineMessages('components.Settings.SettingsNetwork', {
  ...
  networksettingsDescription:
    'Configure network settings for your SethFlix instance.',
  ...
  trustProxyTip:
    'Allow SethFlix to correctly register client IP addresses behind a proxy',
  ...
  forceIpv4FirstTip:
    'Force SethFlix to resolve IPv4 addresses first instead of IPv6',
  dnsCache: 'DNS Cache',
  dnsCacheTip:
