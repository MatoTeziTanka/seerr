...
const messages = defineMessages('components.Settings.SettingsAbout', {
  ...
  supportseerr: 'Support SethFlix',
  contribute: 'Make a Contribution',
  documentation: 'Documentation',
  outofdate: 'Out of Date',
  uptodate: 'Up to Date',
  runningDevelop:
    'You are running the <code>develop</code> branch of SethFlix, which is only recommended for those contributing to development or assisting with bleeding-edge testing.',
});
