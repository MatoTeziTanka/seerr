...
const messages = defineMessages('components.Settings', {
  ...
  manualscanDescriptionJellyfin:
    "Normally, this will only be run once every 24 hours. SethFlix will check your {mediaServerName} server's recently added more aggressively. If this is your first time configuring SethFlix, a one-time full manual library scan is recommended!",
